...
#define CFG_HOLDER	0x00FF55A	/* Change this value to load default configurations */
...
#define SWITCH_GPIO_MUX PERIPHS_IO_MUX_GPIO2_U
#define SWITCH_GPIO_FUNC FUNC_GPIO2
